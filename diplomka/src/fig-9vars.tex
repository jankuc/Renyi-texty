\begin{figure}[htb]
	...
	\:
    \subfloat[][Mt0nl, 2 jets]{\includegraphics[width=0.28\textwidth]{Sig_vs_BG/SB_ele_njet_2_Mt0nl.pdf}} %
	...
	\:
    \subfloat[][Mt0nl, 3 jets]{\includegraphics[width=0.28\textwidth]{Sig_vs_BG/SB_ele_njet_3_Mt0nl.pdf}} %
	...
	\:
    \subfloat[][Mt0nl, 4+ jets]{\includegraphics[width=0.28\textwidth]{Sig_vs_BG/SB_ele_njet_4_Mt0nl.pdf}} %

 \caption{Histograms of signal (\textsf{ttA\_172}, \textsf{ttAll\_172}) and backgrounds in selected variables for electron + jets.}
