...
\begin{definition}
	Let us have the assumptions from previous definition. Moreover, let us have vector of sample weights $(w_1, \ldots,w_n) \in \mathbb{R}$. Then weighted empirical distribution function $F^w_n(x)$ is defined as 
	\begin{equation}
