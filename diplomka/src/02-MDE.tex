...
\ren distance after averaging is displayed in Figure \ref{figJK:distRenPlate}. We can see that the former minima corresponding to the Dirac $\delta-$functions are flattened after blurring and their values are higher than the minimum at point $(0.3, \, 2.3)$.
