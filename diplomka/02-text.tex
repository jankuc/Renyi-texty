...
\begin{definition}
	Let $\varepsilon \in [0,1]$ and $P, Q \in \mathcal{P}$. We write convex mixture of these distributions as  
	\begin{equation}
...
% It means that the family of minimum R\'{e}nyi pseudo-distance estimators defined as $\hat{\theta}_{n,\alpha} = T_{\mathfrak{R}_\alpha}(P_n)$ for $T_{\mathfrak{R}_\alpha}(Q) \in \Theta$ with $Q \in \mathcal{P}^+$ satisfies the condition
